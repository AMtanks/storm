...
class stoc:
    ...
    def from_markdown(cls, text: str, expander=None):
        ...
        <style>
            ...
            [data-testid="stHeading"] h1, div[data-testid="stMarkdown"] h1 { font-family: 'Source Han Sans CN', sans-serif; font-size: 26px; color: #fc5f89; }
            [data-testid="stHeading"] h2, div[data-testid="stMarkdown"] h2 { font-family: 'Source Han Sans CN', sans-serif; font-size: 23px; color: #fc5f89; }
            [data-testid="stHeading"] h3, div[data-testid="stMarkdown"] h3 { font-family: 'Source Han Sans CN', sans-serif; font-size: 20px; color: #fc5f89; }
